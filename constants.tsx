...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 005 0v-.5a2.5 2.5 0 012.5-2.5h.5a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 005 0v-.5a2.5 2.5 0 012.5-2.5h.5a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 005 0V4a2.5 2.5 0 012.5-2.5m-10 0a2.5 2.5 0 00-5 0v.5a2.5 2.5 0 01-5 0v-.5a2.5 2.5 0 00-5 0v.5a2.5 2.5 0 01-5 0V4a2.5 2.5 0 00-5 0m5 16a2.5 2.5 0 01-2.5-2.5v-.5a2.5 2.5 0 00-5 0v.5a2.5 2.5 0 01-2.5 2.5h-.5a2.5 2.5 0 01-2.5-2.5v-.5a2.5 2.5 0 00-5 0v.5a2.5 2.5 0 01-2.5 2.5h-.5a2.5 2.5 0 01-2.5-2.5v-.5a2.5 2.5 0 00-5 0V20a2.5 2.5 0 01-2.5 2.5m10 0a2.5 2.5 0 005 0v-.5a2.5 2.5 0 015 0v.5a2.5 2.5 0 005 0v-.5a2.5 2.5 0 015 0V20a2.5 2.5 0 005 0M9.5 6.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm0 11a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm11-11a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm0 11a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
    </svg>
);
...
export const CoinIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
        <defs>
            <radialGradient id="colorfulCoinGradient" cx="0.3" cy="0.3" r="0.7">
        ...
        {/* Main coin body */}
        <circle cx="12" cy="12" r="11" fill="url(#colorfulCoinGradient)" />
        <circle cx="12" cy="12" r="11" stroke="#b45309" strokeWidth="1" fill="none" opacity="0.8" /> {/* amber-700 border */}
        {/* Star in the middle */}
        <path
            d="M12 4 L14.47 9.53 L20.5 10.32 L16.29 14.4 L17.21 20.4 L12 17.5 L6.79 20.4 L7.71 14.4 L3.5 10.32 L9.53 9.53 Z"
...
export const LEGACY_STYLES = ['Default', 'Photorealistic', 'Cinematic', 'Anime', 'Fantasy', '3D Model', 'Analog Film'];

export const TTS_VOICES = ['Kore', 'Puck', 'Charon', 'Fenrir', 'Zephyr'];

export const SAMPLE_VIDEOS = [
    { name: 'Sci-Fi', url: 'https://storage.googleapis.com/aistudio-samples/scifi_movie.mov' },
    { name: 'Nature', url: 'https://storage.googleapis.com/aistudio-samples/nature_movie.mov' },
    { name: 'Action', url: 'https://storage.googleapis.com/aistudio-samples/action_movie.mov' },
];


// --- FEATURE MAPPING ---

export const FEATURE_ICONS: Record<Feature, React.ReactNode> = {
  [Feature.CHATBOT]: <SparklesIcon className="w-5 h-5" />,
  [Feature.IMAGE_GENERATOR]: <PhotoIcon className="w-5 h-5" />,
  [Feature.IMAGE_ANALYZER]: <PhotoIcon className="w-5 h-5" />,
  [Feature.VIDEO_GENERATOR]: <FilmIcon className="w-5 h-5" />,
  [Feature.VIDEO_ANALYZER]: <FilmIcon className="w-5 h-5" />,
  [Feature.VIDEO_EDITING]: <FilmIcon className="w-5 h-5" />,
  [Feature.LIVE_AGENT]: <MicrophoneIcon className="w-5 h-5" />,
  [Feature.GROUNDING_SEARCH]: <SearchIcon className="w-5 h-5" />,
  [Feature.COMPLEX_TASK_SOLVER]: <BrainCircuitIcon className="w-5 h-5" />,
  [Feature.TEXT_TO_SPEECH]: <SpeakerWaveIcon className="w-5 h-5" />,
};
